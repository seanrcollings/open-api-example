...
class TestEnvironmentController(BaseTestCase):
    ...
    def test_get_forecast(self):
        ...
        response = self.client.open(
            '/sean.collings/DemoAPI/1.0.0/temperature/forecast/{days}'.format(days=56),
            method='GET')
    ...
    def test_get_heater_state(self):
        ...
        """
        response = self.client.open(
            '/sean.collings/DemoAPI/1.0.0/temperature/{zoneId}/heater'.format(zone_id='zone_id_example'),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_get_zone_temperature(self):
        ...
        """
        response = self.client.open(
            '/sean.collings/DemoAPI/1.0.0/temperature/{zoneId}'.format(zone_id='zone_id_example'),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_set_heater_state(self):
        ...
        """
        response = self.client.open(
            '/sean.collings/DemoAPI/1.0.0/temperature/{zoneId}/heater/{state}'.format(zone_id='zone_id_example', state='state_example'),
            method='POST')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_temperature_summary(self):
        ...
        """
        response = self.client.open(
            '/sean.collings/DemoAPI/1.0.0/temperature',
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
